...
const { sanitizedUser, sendMail } = require("../services/common");
  ...
  try {
    ...
    crypto.pbkdf2(
      ...
      async function (err, hashedPassword) {
        ...
        req.login(sanitizedUser(doc), () => {
          //this also calls serializer and adds session
          if (err) {
...
exports.resetPasswordRequest = async (req, res) => {
  ...
  if (user) {
    ...
    //lets send email and a token in the mail body so we can verify that user clicked right link
    if (email) {
